...
# Create Chad Powers Season 2 landing page with analytics tracking
# Run from your castingcompanion3 root directory

echo "🏈 Creating Chad Powers Season 2 landing page..."

mkdir -p src/app/apply-chad-powers

cat > src/app/apply-chad-powers/page.tsx << 'ENDOFFILE'
'use client';
...
echo "✅ Chad Powers page created"

# Git commit and push
echo ""
echo "📦 Committing and pushing..."
git add -A
git commit -m "Add Chad Powers Season 2 landing page with analytics tracking"
git push origin main

echo ""
echo "============================================"
echo "✅ Done! Your new page will be live at:"
echo ""
echo "   https://castingcompanion.com/apply-chad-powers"
echo ""
echo "📊 Analytics source: 'chad-powers'"
echo "📧 Casting email: football@gamechangingfilms.com"
echo "🎨 Theme: Green/Yellow football gradient"
echo "============================================"
