...
function ApplyPageContent() {
  ...
  const castingEmail = 'ExtraCfire@gmail.com';
  const castingTitle = 'Chicago Fire';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/auth/register', {
        ...
        body: JSON.stringify({ email, password, name, role: 'ACTOR', source: 'chicago-fire' }),
      });
      ...
      if (res.ok) {
        ...
        localStorage.setItem("landingPageShowName", "Chicago Fire");
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-block bg-red-600 text-white px-6 py-2 rounded-full text-sm font-semibold mb-4 animate-pulse">🔴 NOW CASTING • EXTRAS NEEDED</div>
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">CHICAGO FIRE</h1>
          ...
          <div id="register" className="bg-white rounded-xl shadow-2xl p-8 md:p-12 scroll-mt-8">
            <div className="max-w-md mx-auto">
              <div className="text-center mb-8"><h2 className="text-3xl font-bold text-gray-900 mb-2">Complete Your Chicago Fire Application</h2><p className="text-gray-600 text-lg">Create your actor profile and get submitted to Chicago Fire PLUS dozens of other matching roles automatically</p></div>
...
export default function ApplyChicagoFirePage() {
