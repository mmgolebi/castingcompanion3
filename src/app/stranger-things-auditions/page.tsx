...
function StrangerThingsPageContent() {
  const router = useRouter();
  const searchParams = useSearchParams();
  const castingEmail = searchParams.get('email') || 'casting@example.com';
  const castingTitle = searchParams.get('title') || 'Stranger Things Season 5';
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-950 via-black to-red-950">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          <Link href="/">
            <div className="text-3xl font-bold text-red-500 inline-block" style={{ textShadow: '0 0 20px rgba(239, 68, 68, 0.5)' }}>
              Casting Companion
            </div>
          </Link>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          {/* Headline */}
          <div className="text-center mb-8">
            <div className="inline-block bg-red-600 text-white px-6 py-2 rounded-full text-sm font-semibold mb-4 animate-pulse" style={{ boxShadow: '0 0 30px rgba(220, 38, 38, 0.6)' }}>
              🔴 NOW CASTING
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-red-500 mb-4" style={{ 
              textShadow: '0 0 40px rgba(239, 68, 68, 0.8), 0 0 60px rgba(220, 38, 38, 0.5)',
          ...
          {/* Video */}
          <div className="mb-8">
            <div className="aspect-video bg-black rounded-xl overflow-hidden border-4 border-red-600 shadow-2xl" style={{ boxShadow: '0 0 60px rgba(220, 38, 38, 0.4)' }}>
              <video 
          ...
          <div className="text-center space-y-4 mb-16">
            <Button 
              ...
              size="lg" 
              className="w-full md:w-auto text-xl px-12 py-8 bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white font-bold rounded-xl shadow-2xl transform hover:scale-105 transition-all"
          ...
          {/* Benefits */}
          <div className="bg-black/60 backdrop-blur-lg rounded-xl p-8 mb-16 border border-red-900/30">
            <h2 className="text-2xl font-bold text-red-500 text-center mb-6">
              Why actors choose CastingCompanion
            </h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-3" style={{ boxShadow: '0 0 20px rgba(220, 38, 38, 0.5)' }}>
                  <Check className="h-6 w-6 text-white" />
                </div>
                <h3 className="text-red-400 font-semibold mb-2">Auto-Submit</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="text-red-400 font-semibold mb-2">Save Time</h3>
                <p className="text-gray-400 text-sm">
              ...
              <div className="text-center">
                ...
                <h3 className="text-red-400 font-semibold mb-2">Never Miss</h3>
                <p className="text-gray-400 text-sm">
          ...
          {/* Registration Form */}
          <div id="register" className="bg-white rounded-xl shadow-2xl p-8 md:p-12 scroll-mt-8" style={{ boxShadow: '0 0 80px rgba(220, 38, 38, 0.3)' }}>
            <div className="max-w-md mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-12 text-lg bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900"
                >
      ...
      {/* Footer */}
      <footer className="border-t border-red-900/30 mt-20 py-8">
...
export default function StrangerThingsAuditionsPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gradient-to-br from-red-950 via-black to-red-950 flex items-center justify-center"><div className="text-red-500">Loading...</div></div>}>
      <StrangerThingsPageContent />
    </Suspense>
  );
}
